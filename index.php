...
class House {
    ...
    public function __construct($image, $name, $description, $price, $address, $realtorName, $realtorImage, $realtorPhone, $bedrooms, $bathrooms) {
        $this->image = $image;
        $this->name = $name;
        ...
        echo '<p class="text-gray-700">' . $this->address . '</p>
          ...
          <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
            ...
            <div class="flex items-center pt-2">
              <div class="bg-cover bg-center w-10 h-10 rounded-full mr-3" style="background-image: url(' . $this->realtorImage . ')">
              </div>
              <div>
                <p class="font-bold text-gray-900">' . $this->realtorName . '</p>
                <p class="text-sm text-gray-700">' . $this->realtorPhone . '</p>
              </div>
            </div>
          </div>
        </div>
